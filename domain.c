...
#if defined(GALSF) && !defined(STOCHASTIC_IMF) && !defined(SAMPLE_IMF_FROM_GAS)/* with star formation active, we will up-weight star particles which are active feedback sources */
